...
8. "cleanBody": Structured, high-density, ULTRA-COMPACT readable digest strictly in ENGLISH. DO NOT use multiple line breaks. DO NOT use emojis. Strip out all spaces between paragraphs, use only single `\n`. Remove legal footers, unsubscribe links, duplicate subjects, and tracking noise. Preserve key URLs cleanly.
