...
1. "author": Clean sender/service name (e.g. "Manychat", "Vercel", "Google", "Lloyd Alvarez", "You (Sent)"). Max 2 words.
2. "geminiTitle": Sharp, concise title strictly in ENGLISH. Max 6 words.
3. "urgency":
...
4. "threadTopic": Normalized English topic slug.
...
7. "suggestedTodoTitle": Clear Russian action directive if actionable (e.g. "Исправить ошибку деплоя Vercel", "Продлить подписку Manychat"). No colons or ampersands.
8. "cleanBody": Structured, high-density, readable digest strictly in ENGLISH. Remove legal footers, unsubscribe links, duplicate subjects, and tracking noise. Preserve key URLs cleanly.
