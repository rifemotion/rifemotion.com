...
2. "geminiTitle": Maximum 25 characters. Sharp, concise, INVENTED title strictly in ENGLISH (e.g. "Train Ticket", "Manychat Limit", "Security Alert", "Vercel Failed"). Max 3 words. NO EMOJIS.
3. "urgency":
      ...
      if (res.ok) {
        ...
        if (text) {
          ...
          return {
            ...
            geminiTitle: (parsed.geminiTitle || subject).trim().slice(0, 25),
