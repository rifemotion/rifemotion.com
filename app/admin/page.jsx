...
export default function AdminDashboardPage() {
  ...
  const cleanCategoryName = (cat) => {
    ...
    const lower = (cat ? String(cat).toLowerCase() : "");
        ...
        {activeTab === "settings" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem", maxWidth: "860px" }}>
            ...
            <div style={{ background: "var(--bg-panel, #131316)", border: "1px solid var(--border-subtle, rgba(255,255,255,0.08))", borderRadius: "6px", padding: "1.2rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
              ...
              <div style={{ background: "var(--bg-panel, #131316)", border: "1px solid rgba(220, 38, 38, 0.2)", borderRadius: "6px", padding: "1.2rem", display: "flex", flexDirection: "column", gap: "1rem", marginTop: "1rem" }}>
                <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                  <h4 style={{ fontSize: "0.85rem", margin: "0", color: "#ef4444", fontWeight: 700 }}>Emergency Database Reset</h4>
                  <p style={{ fontSize: "0.75rem", color: "var(--text-secondary)", margin: "0" }}>
                    Clear all messages from the database and fetch the 5 latest emails from each connected inbox, processing them through Gemini.
                  </p>
                </div>
                <button 
                  type="button"
                  onClick={handleResetFetchMessages} 
                  style={{ background: "rgba(220, 38, 38, 0.15)", color: "#ef4444", border: "1px solid rgba(220, 38, 38, 0.3)", padding: "8px 14px", borderRadius: "5px", fontSize: "0.75rem", cursor: "pointer", fontWeight: 600, alignSelf: "flex-start", display: "flex", gap: "8px", alignItems: "center" }}
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 6h18M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a2 2 0 012-2h4a2 2 0 012 2v2"/></svg>
                  Reset Database & Fetch Latest 5
                </button>
              </div>
</div>
        )}
